...
export default function Blog() {
  return (
    <div>
      <div className='bg-[#386C79] sm:bg-left-flower bg-no-repeat bg-contain mt-10'>
      ...
      <ul className='md:max-w-7xl max-w-xs mx-auto'>
        ...
        <li key={2} className='py-12 max-w-7xl mx-auto  '>
          <article>
            <div className='space-y-2 md:grid md:grid-cols-4 md:items-baseline md:space-y-0'>
              <dl>
                <dd className='text-xl font-semibold leading-6 text-gray-500 dark:text-gray-400 '>
                  <div className='items-center justify-center hidden md:flex'>
                    <span className='flex items-center justify-center w-4 h-4 mr-2 rounded-xl bg-miradorGreen'></span>
